			...
			<div class="col-12 mt-2">
				<table class="">
					<tr>
						...
						<td class="border border-secondary" style="width: 9%;">價格</td>
						<!-- <td class="border border-secondary" style="width: 5%;">顏色</td>
						<td class="border border-secondary" style="width: 5%;">尺寸</td> -->
						...
						<td class="border border-secondary" style="width: 9%;">庫存量</td>
					...
					<tr>
						...
						<td class="border border-secondary"
							style="width: 9%; height: 50px;">${product.product_title}</td>
						<td class="border border-secondary"
							style="width: 9%; height: 50px;">${product.product_id}</td>
						<td class="border border-secondary"
							style="width: 9%; height: 50px;">${product.productNo}</td>
						<td class="border border-secondary"
							style="width: 9%; height: 50px;">${product.product_price}</td>
						<td class="border border-secondary"
							style="width: 5%; height: 50px;">${product.product_textdetails}</td>
						<td class="border border-secondary"
							style="width: 5%; height: 50px;"></td>
						<td class="border border-secondary"
