...
<body>
    ...
    <div class="side-menu" style="float:left;margin-right:70px;">
        ...
        <nav>
            <a href="<c:url value='#' />"><i class="fa fa-home" aria-hidden="true"></i>主辦/報名活動管理</a>
            <a href="#"><i class="fa fa-home" aria-hidden="true"></i>活動留言管理</a>
            <a href="#"><i class="fa fa-home" aria-hidden="true"></i>商品留言管理</a>
            <a href="#"><i class="fa fa-home" aria-hidden="true"></i>訂單紀錄</a>
            <a href="#"><i class="fa fa-home" aria-hidden="true"></i>購物車</a>
        </nav>
