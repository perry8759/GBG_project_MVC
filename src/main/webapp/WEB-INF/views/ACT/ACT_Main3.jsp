                                        ...
                                        <div class="game_container_main">
                                            <div class="game_list_search_dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="<c:url value='/ACT/ACT_Main?sportid=${sportid}&state=${state}&order=asc&start=${start}'/>">升序</a>
                                                    <a class="dropdown-item" href="<c:url value='/ACT/ACT_Main?sportid=${sportid}&state=${state}&order=desc&start=${start}'/>">降序</a>
                                                </div>
                                            </div>
                                            <div class="game_list_search_dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="<c:url value='/ACT/ACT_Main?sportid=${sportid}&state=1&order=${order}&start=${start}'/>">已截止</a>
                                                    <a class="dropdown-item" href="<c:url value='/ACT/ACT_Main?sportid=${sportid}&state=2&order=${order}&start=${start}'/>">報名中</a>
                                                    <a class="dropdown-item" href="<c:url value='/ACT/ACT_Main?sportid=${sportid}&state=3&order=${order}&start=${start}'/>">尚未開放報名</a>
                                                </div>
                                            </div>
                                ...
                                <table class="game-list">
                                    ...
                                    <tbody>
                                        <tr class="game-list_row">
                                            ...
                                            <td class="game-list_name"><a href="<c:url value='/ACT/ACT_Main/${act.ACT_ID}'/>">${act.ACT_TITLE}</a></td>
                                            ...
                                            <td class="game-list_focus">
                                               <a href="<c:url value='/ACT/ACT_follow/${act.ACT_ID}?sportid=${sportid}&state=${state}&order=${order}&start=${start}'/>">
                     ...
                     <div class="row mt-5 mb-5">
                        <div class="col text-center">
                            <div class="block-sport-dos">
                                <ul>
                                    <li><a href="?start=${pre}&sportid=${sportid}&state=${state}&order=${order}">&lt;</a></li>
                                    <c:forEach items="${allpage}" var="item">
                                         <li><a href="?start=${(item-1)*5}&sportid=${sportid}&state=${state}&order=${order}">${item}</a></li>
                                    </c:forEach>                      
                                    <li><a href="?start=${next}&sportid=${sportid}&state=${state}&order=${order}">&gt;</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
